...
public class NdfdXMLLocator extends org.apache.axis.client.Service implements gov.nationalweather.NdfdXML {
 ...
 */
    ...
    public gov.nationalweather.NdfdXMLPortType getndfdXMLPort() throws javax.xml.rpc.ServiceException {
    ...
    public gov.nationalweather.NdfdXMLPortType getndfdXMLPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gov.nationalweather.NdfdXMLBindingStub _stub = new gov.nationalweather.NdfdXMLBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (gov.nationalweather.NdfdXMLPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                gov.nationalweather.NdfdXMLBindingStub _stub = new gov.nationalweather.NdfdXMLBindingStub(new java.net.URL(ndfdXMLPort_address), this);
                _stub.setPortName(getndfdXMLPortWSDDServiceName());
                return _stub;
            }
        }
